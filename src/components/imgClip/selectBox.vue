<template>
  <div class="crop-wrap">
    ...
    <div class="crop-box" @mousedown="boxTouchDown" :class="showBox ? 'show': ''" :style="recStyle">
      <span class="drag-point point-lt" @mousedown="pointTouchDown('drag-lt', $event)"><span></span></span>
      <span class="drag-point point-lb" @mousedown="pointTouchDown('drag-lb', $event)"><span></span></span>
      <span class="drag-point point-rt" @mousedown="pointTouchDown('drag-rt', $event)"><span></span></span>
      <span class="drag-point point-rb" @mousedown="pointTouchDown('drag-rb', $event)"><span></span></span>
    </div>
  </div>
</template>
